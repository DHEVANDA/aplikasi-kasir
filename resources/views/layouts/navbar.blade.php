...
<body class="bg-gray-100">
    ...
    <nav class="bg-gray-600 p-4 shadow-md">
        <div class="container mx-auto flex justify-between items-center">
            ...
            <div class="flex items-center space-x-4">
                <a href="{{ route('transactions.index') }}"
                    class="text-white text-2xl font-bold hover:text-gray-500 transition">
            ...
            <div class="hidden lg:flex space-x-6">
                <a href="{{ route('transactions.create') }}" class="text-white text-lg hover:text-gray-500 transition">
                    <i class="fas fa-plus-circle"></i> Tambah Transaksi
                </a>
                <a href="{{ route('products.index') }}" class="text-white text-lg hover:text-gray-500 transition">
                    <i class="fas fa-box-open"></i> Daftar Produk
                </a>
                <a href="{{ route('products.create') }}" class="text-white text-lg hover:text-gray-500 transition">
                    <i class="fas fa-plus-square"></i> Tambah Produk
                </a>
                <a href="{{ route('transactions.reportForm') }}"
                    class="text-white text-lg hover:text-gray-500 transition">
        ...
        <div id="navbar-menu"
            ...
            <a href="{{ route('transactions.index') }}"
                class="flex items-center text-white hover:text-gray-500 transition">
            ...
            <a href="{{ route('products.index') }}" class="flex items-center text-white hover:text-gray-500 transition">
